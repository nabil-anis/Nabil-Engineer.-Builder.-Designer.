...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  },
  {
    id: 'jsmu-2025',
    title: 'TA’EED',
    description: 'Secured 2nd position province-wide at the JSMU Annual Education & Research Symposium. A culturally grounded, voice-enabled healthcare AI designed for low-literacy users, primarily in Urdu, with bilingual support for broader accessibility. It explains medicines in simple terms, suggests safe generic alternatives, performs preliminary symptom screening, and evaluates drug, food, and traditional-remedy interactions. When risk is detected, TAEED provides clear, non-negotiable guidance, prioritizing patient safety. Positioned as a support layer rather than a diagnostic authority, it bridges the gap between clinical care and everyday medication decisions in communities where language barriers and self-medication increase risk.',
